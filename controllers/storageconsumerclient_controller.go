...
import (
	...
	v1alpha1 "github.com/red-hat-storage/storage-consumer-operator/api/v1alpha1"
...
func (r *StorageConsumerClientReconciler) deletionPhase(instance *v1alpha1.StorageConsumerClient, externalClusterClient *providerClient.OCSProviderClient) (ctrl.Result, error) {
	...
	//returnErr := r.SetOperatorConditions("Skipping StorageConsumerClient reconcilation", "Terminated", metav1.ConditionTrue, nil)
	return reconcile.Result{}, nil
}
